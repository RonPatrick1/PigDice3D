window.Physijs = (function() {
	...
	Physijs.BoxMesh = function( geometry, material, mass ) {
		...
		this._physijs.depth = depth;
                //alert("max.x: "+geometry.boundingBox.max.x+" min.x: "+geometry.boundingBox.min.x);
		//alert("max.y: "+geometry.boundingBox.max.y+" min.y: "+geometry.boundingBox.min.y);
		//alert("max.z: "+geometry.boundingBox.max.z+" min.z: "+geometry.boundingBox.min.z);
